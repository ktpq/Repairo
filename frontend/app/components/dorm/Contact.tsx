...
export default function Contact({dorm_id}: ContactProps) {
    const mapUrl =
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3875.8862493533798!2d100.76185267586484!3d13.725335997904159!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311d664c6d617523%3A0x22cf2a25328baf20!2sU-Place!5e0!3m2!1sth!2sth!4v1761652568515!5m2!1sth!2sth"
    // Mock data
    const mockdata = {
    ...
    useEffect(() => {
        const fetchDormData = async () => {
            try{
                ...
                const response = await axios.get(`${base_api}/dorm/${dorm_id}`, {withCredentials: true})
                // console.log("dormData", response.data)
                setDormData(response.data.dorm)
            } catch(error){
